...
import { CategoryFacetResponse, CategoryFacetValue } from '../../category-facet-set/interfaces/response';
...
export declare type AnyFacetResponse = FacetResponse | RangeFacetResponse | CategoryFacetResponse;
export declare type AnyFacetValue = FacetValue | NumericFacetValue | CategoryFacetValue | DateFacetValue;
