import { BaseFacetRequest, SortCriteria, BaseFacetValueRequest, RangeAlgorithm } from '../../../facet-api/request';
...
export declare type RangeFacetRangeAlgorithm = 'even' | 'equiprobable';
