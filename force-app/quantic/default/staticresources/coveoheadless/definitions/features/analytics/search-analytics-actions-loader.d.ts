...
import { LogStaticFilterToggleValueActionCreatorPayload, LogStaticFilterClearAllActionCreatorPayload, StaticFilterValueMetadata } from '../static-filter-set/static-filter-set-actions';
export type { LogCategoryFacetBreadcrumbActionCreatorPayload, LogFacetBreadcrumbActionCreatorPayload, LogFacetDeselectActionCreatorPayload, LogFacetSelectActionCreatorPayload, LogFacetUpdateSortActionCreatorPayload, LogDateFacetBreadcrumbActionCreatorPayload, LogNumericFacetBreadcrumbActionCreatorPayload, LogQuerySuggestionClickActionCreatorPayload, QuestionAnsweringDocumentIdActionCreatorPayload, LogStaticFilterToggleValueActionCreatorPayload, LogStaticFilterClearAllActionCreatorPayload, StaticFilterValueMetadata, };
/**
...
export interface SearchAnalyticsActionCreators {
     ...
     * @returns A dispatchable action.
     */
    logStaticFilterSelect(payload: LogStaticFilterToggleValueActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logStaticFilterDeselect(payload: LogStaticFilterToggleValueActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logStaticFilterClearAll(payload: LogStaticFilterClearAllActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
}
/**
